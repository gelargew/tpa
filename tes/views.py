    ...
    if request.POST.get('selesai') == 'selesai':
        ...
        if current_user:
            ...
            for people in peserta:
                ...
                people.nilai = nilai
                people.save()
        return HttpResponseRedirect('http://127.0.0.1:8000/subtest2/')
...
def subtest2(request):
    ...
    if request.POST.get('selesai') == 'selesai':
        ...
        if current_user:
            ...
            x.save()
            return HttpResponseRedirect('http://127.0.0.1:8000/subtest3/')
    return HttpResponse(template.render(context, request))
...
def subtest3(request):
    ...
    if request.POST.get('selesai') == 'selesai':
        ...
        if current_user:
            ...
            x.nilai = x.subtest1 + x.subtest2 + x.subtest3 + x.subtest4
            x.save()
            return HttpResponseRedirect('http://127.0.0.1:8000/subtest4/')
    return HttpResponse(template.render(context, request))
...
def subtest4(request):
    ...
    if request.POST.get('selesai') == 'selesai':
        ...
        if current_user:
            ...
            x.nilai = x.subtest1 + x.subtest2 + x.subtest3 + x.subtest4
            x.save()
            return HttpResponseRedirect('http://127.0.0.1:8000/finish/' )
    return HttpResponse(template.render(context, request))
...
def login(request):
    ...
    if form:
        ...
        return HttpResponseRedirect('http://127.0.0.1:8000/tes/')
